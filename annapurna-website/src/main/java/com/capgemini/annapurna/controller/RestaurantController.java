...
public class RestaurantController {
	 ...
	 * restTemplate.getForEntity("http://localhost:8081/restaurants/"+restaurantId,
	 * Restaurant.class); model.addAttribute("restaurant", entity.getBody()); return
	 * "FoodItems"; }
	 */
	...
	public String search(Model model, @RequestParam String search) {
		ResponseEntity<Restaurant[]> entity = restTemplate.getForEntity("http://localhost:8081/restaurants", Restaurant[].class);
