...
public class Restaurant {
	 ...
	 * 
	 * public static int nextValue() { return counter.getAndIncrement(); }
	 */
	
	@Id //@Indexed //@Generated(value = {""})
	private Integer restaurantId ;	//"auto-increment" restricts parallelism, specially on distributed systems = nextValue()
	private String name;
